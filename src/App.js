...
function App() {
  ...
  // Aspect ratio configurations - FIXED: moved to useMemo to prevent dependency changes
  ...
  // Get current aspect ratio - FIXED: added proper dependencies
  ...
  // Download all cropped images with proper dependencies - FIXED: added getCurrentRatio dependency
